...
{
    public class B_inmuebles_visitas_2Controller : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (idCartera == 3)
            {
                return Redirect("~/B_inmuebles_visitas");
            }
        ...
        {
            //para 2023 no se permite editar
            return Redirect("~/Home");
        ...
        {
            //para 2023 no se permite eliminar
            return Redirect("~/Home");
