...
{
    public class B_inmueblesController : Controller
    {
        ...
        // GET: b_inmueblesController/Details/5
        //[Route("Inmuebles/Detalle")]
        //[Route("Inmuebles/Detalle/{id?}")]
        public ActionResult Details(int id)
        {
            ...
            DataPropietarios dataPropietarios = new DataPropietarios();            
            ViewBag.lstPropietarios = dataInmuebles.GetListaPropietarios();

            return View(b_inmuebles);
        }

        // GET: b_inmueblesController/Create
        //[Route("Inmuebles/Nuevo")]
