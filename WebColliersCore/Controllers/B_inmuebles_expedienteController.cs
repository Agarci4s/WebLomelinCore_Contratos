...
{
    public class B_inmuebles_expedienteController : Controller
    {
        ...
        public ActionResult DetailsVisita(int id)
        {
            ...
            DataInmuebles dataInmuebles = new DataInmuebles();
            B_inmuebles_expediente b_inmuebles_expediente = new B_inmuebles_expediente();
            ...
            List<B_inmuebles_expediente_detalle_contratos> b_inmuebles_expediente_detalle_contratos = dataInmueblesExpedienteContratos.GetById(id);


            return View(b_inmuebles_expediente_detalle_contratos);
